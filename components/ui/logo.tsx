...
export default function Logo() {
  return (
    <Link href="/" className="inline-flex items-center gap-2" aria-label="AiFlow Consulting">
      ...
      <span className="text-sm font-semibold text-gray-800">AiFlow Consulting</span>
    </Link>
  );
}

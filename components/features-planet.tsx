        ...
        <div className="py-12 md:py-20">
          ...
          <div className="mx-auto max-w-3xl pb-16 text-center md:pb-20">
            <h2 className="text-3xl font-bold text-gray-200 md:text-4xl">
              End-to-end AI software services
            </h2>
            <p className="mt-4 text-gray-400">
              From initial concept to production deployment, we cover every
          ...
          <div className="grid overflow-hidden sm:grid-cols-2 lg:grid-cols-3 *:relative *:p-6 *:before:absolute *:before:bg-gray-800 *:before:[block-size:100vh] *:before:[inline-size:1px] *:before:[inset-block-start:0] *:before:[inset-inline-start:-1px] *:after:absolute *:after:bg-gray-800 *:after:[block-size:1px] *:after:[inline-size:100vw] *:after:[inset-block-start:-1px] *:after:[inset-inline-start:0] md:*:p-10">
            <article>
              <h3 className="mb-2 flex items-center space-x-2 font-medium text-gray-200">
                <svg className="fill-blue-500" xmlns="http://www.w3.org/2000/svg" width={16} height={16}>
                  <path d="M8 0a1 1 0 0 1 1 1v6a1 1 0 1 1-2 0V1a1 1 0 0 1 1-1Zm0 10a2 2 0 1 1 0 4 2 2 0 0 1 0-4Z" />
                </svg>
                <span>AI Strategy</span>
              </h3>
              <p className="text-[15px] text-gray-400">
                We help you identify where AI creates real business value —
                defining a roadmap that aligns technology decisions with your
                goals.
              </p>
            </article>
            <article>
              ...
              <p className="text-[15px] text-gray-400">
                Bespoke AI-powered software built for your specific needs —
                from internal tools to customer-facing SaaS products.
              </p>
            </article>
            <article>
              <h3 className="mb-2 flex items-center space-x-2 font-medium text-gray-200">
                ...
                <span>iOS &amp; Mobile Apps</span>
              </h3>
              <p className="text-[15px] text-gray-400">
                Native iOS and cross-platform mobile applications designed for
            ...
            <article>
              ...
              <p className="text-[15px] text-gray-400">
                Turn raw data into actionable intelligence with custom
                pipelines, dashboards, and machine learning models.
              </p>
            </article>
            <article>
              <h3 className="mb-2 flex items-center space-x-2 font-medium text-gray-200">
              ...
              <p className="text-[15px] text-gray-400">
                Connect your existing systems, third-party services, and AI
                models through clean, well-documented API layers.
              </p>
            </article>
            <article>
              <h3 className="mb-2 flex items-center space-x-2 font-medium text-gray-200">
              ...
              <p className="text-[15px] text-gray-400">
                Long-term retainer engagements for teams who want a dedicated
                AI engineering partner — from maintenance to new features.
              </p>
            </article>
          </div>
        </div>
